...
# This scripts main scene(interactable.tscn) should be put as a child to the object that is to be interacted with.
...
func pass_interaciton() -> void:
	...
	if interaction_object.has_method("on_interact"):
